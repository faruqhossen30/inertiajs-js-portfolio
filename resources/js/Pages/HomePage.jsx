        ...
        <AppLayout>
            ...
            <section>
                ...
                <div className="py-20 bg-gray-50 radius-for-skewed">
                    ...
                    <div className="container group-[]: grid grid-cols-12 gap-10">
                        {[1,2,1,2,1,2].map((item, index)=>{
                            return <div key={index} className={`col-span-3 h-96 w-full bg-[url('/2.png')] bg-cover bg-top hover:bg-bottom transition-all duration-[20s] ease-out rounded-2xl border`}>
                            <a className="inline-block m-3  px-2 border-2 border-green-500 hover:border-white bg-transparent text-white bg-green-500 hover:bg-white hover:text-gray-900 transition duration-200 rounded-l-xl rounded-t-xl font-bold leading-loose" href="#">View Project</a>
                        </div>
                        })
